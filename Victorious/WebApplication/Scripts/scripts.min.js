...
jQuery(document).ready(function(){function e(){a("#TournamentCreate .bracketInfo").addClass("hide"),a("."+n[a("#TournamentCreate #BracketType").val()]).removeClass("hide")}var r,a=jQuery,n={3:"rr",6:"swiss"},t=0;a("#TournamentCreate #BracketType").on("change",e),a("#TournamentCreate .icon-plus").on("click",function(){var e=r.replace(/%n%/g,t);a("#TournamentCreate .bracketSection").append("<ul class='brackets'>"+e+"</ul>"),t++}),function(a){1==a("#TournamentCreate").length&&(e(),r=a("#TournamentCreate .bracketOrig").removeClass("hide").html(),a("#TournamentCreate .bracketOrig").remove())}(a)});
jQuery(document).ready(function(){function e(){var e=r(this).data("id");e>-1&&r(".TournamentMatch .defender[data-id='"+e+"'], .TournamentMatch .challenger[data-id='"+e+"']").addClass("teamHover")}function a(){var e=r(this).data("id");e>-1&&r(".TournamentMatch .defender[data-id='"+e+"'], .TournamentMatch .challenger[data-id='"+e+"']").removeClass("teamHover")}function n(e,a){overview=a.find(".overview"),games=a.find(".TournamentGames"),overview.find(".defender .name").text(e.defender.name),overview.find(".defender .score").text(e.defender.score),overview.find(".defender").attr("data-id",e.defender.id).data("id",e.defender.id),overview.find(".challenger .name").text(e.challenger.name),overview.find(".challenger .score").text(e.challenger.score),overview.find(".challenger").attr("data-id",e.challenger.id).data("id",e.challenger.id),games.find(".defender.name").text(e.defender.name),games.find(".challenger.name").text(e.challenger.name),games.find(".games").empty(),r.each(e.games,function(e,a){t(a,games)}),e.ready?a.find(".details").removeClass("hide"):a.find(".details").addClass("hide")}function t(n,t){html="<ul class='form gameDetail' data-columns='4' data-gameid='"+n.id+"' data-gamenum='"+n.gameNum+"'> ",html+="<li class='column game-number'>"+n.gameNum+"</li> ",html+="<li class='column defender score' data-id='"+n.defender.id+"'><input type='text' class='defender-score' name='defender-score' maxlength='3' value='"+n.defender.score+"' /></li> ",html+="<li class='column challenger score' data-id='"+n.challenger.id+"'><input type='text' class='challenger-score' name='challenger-score' maxlength='3' value='"+n.challenger.score+"' /></li> ",html+="<li class='column'><span class='icon icon-bin removeGame'></span></li> ",html+="</ul> ",t.find(".games").append(html),r(".TournamentMatch .defender, .TournamentMatch .challenger").off("mouseover").on("mouseover",e),r(".TournamentMatch .defender, .TournamentMatch .challenger").off("mouseleave").on("mouseleave",a),r(".TournamentMatch .removeGame").off("click").on("click",s)}function d(e){return!(e.find(".games ul").length>=e.find(".games").data("max"))}function o(e,a){d(a)?a.find(".options .add-game").removeClass("hide"):a.find(".options .add-game").addClass("hide"),e.finished?(a.find(".update-games").addClass("hide"),a.find(".options .add-game").addClass("hide")):a.find(".update-games").removeClass("hide")}function s(){var e=r(this).closest("ul"),a={tournamentId:r("#Tournament").data("id"),bracketId:e.closest(".bracket").data("id"),matchId:e.closest(".TournamentMatch").data("id"),matchNum:e.closest(".TournamentMatch").data("matchnum"),gameId:e.data("gameid"),gameNum:e.data("gamenum")};r.ajax({url:"/Ajax/Match/RemoveGame",type:"post",data:{jsonData:JSON.stringify(a)},dataType:"json",beforeSend:function(){},success:function(a){console.log(a),a.status?(UpdateStandings(r("#Tournament").data("id"),e.closest(".bracket").data("id")),r.each(a.data,function(e,a){$match=r(".TournamentMatch[data-id='"+a.matchId+"']"),n(a,$match),o(a,$match),$games=$match.find(".TournamentGames"),$games.find(".games").empty(),r.each(a.games,function(e,a){t(a,$games)})})):console.log(a.message)},error:function(e){console.log(e)},complete:function(){}})}var r=jQuery;r(".TournamentMatch .defender, .TournamentMatch .challenger").on("mouseover",e),r(".TournamentMatch .defender, .TournamentMatch .challenger").on("mouseleave",a),r(".TournamentGames .removeGame").on("click",s),r(".TournamentGames .options .close").on("click",function(){r(this).closest(".TournamentGames").removeClass("open")}),r(".TournamentGames .options .add-game").on("click",function(){var e=r(this).closest(".TournamentGames"),a=(e.data("max"),e.find(".list-table-body ul").length),n=r(e.find(".games ul")[a-1]).data("gamenum")+1;jsonData={id:-1,gameNum:isNaN(n)?1:n,challenger:{score:""},defender:{score:""}},t(jsonData,e),d(e)?r(this).removeClass("hide"):r(this).addClass("hide")}),r(".TournamentMatch .details").on("click",function(){var e=r(this).closest(".TournamentMatch"),a={tournamentId:r("#Tournament").data("id"),bracketId:e.closest(".bracket").data("id"),matchId:e.data("id")};r.ajax({url:"/Ajax/Match",type:"POST",data:a,dataType:"json",beforeSend:function(){r(".TournamentInfo, .TournamentGames").removeClass("open"),e.find(".TournamentGames").addClass("open"),e.find(".TournamentGames .list-table-body").empty()},success:function(a){a.status?(console.log(a),$games=e.find(".TournamentGames"),n(a.data,e),o(a.data,$games)):console.log(a.message)},error:function(a){console.log(a),e.find(".TournamentGames").removeClass("open")},complete:function(){}})}),r(".TournamentGames .update-games").on("click",function(){var e=r(this).closest(".TournamentMatch"),a=e.find(".games ul"),t=new Array;r.each(a,function(e,a){defenderScore=r(a).find(".defender-score").val(),challengerScore=r(a).find(".challenger-score").val(),defenderScoreValid=r.isNumeric(defenderScore)||Math.floor(defenderScore)!=defenderScore,challengerScoreValue=r.isNumeric(challengerScore)||Math.floor(challengerScore)!=challengerScore,defenderScoreValid&&challengerScoreValue?r(a).find(".score").removeClass("invalid"):r(a).find(".score").addClass("invalid")}),r.each(a,function(e,a){t.push({GameNumber:r(a).data("gamenum"),DefenderScore:r(a).find(".defender-score").val(),ChallengerScore:r(a).find(".challenger-score").val()})});var d={matchId:e.data("id"),matchNum:e.data("matchnum"),bracketId:r(this).closest(".bracket").data("id"),tournamentId:r("#Tournament").data("id"),games:a};r.ajax({url:"/Ajax/Match/Update",type:"POST",data:d,dataType:"json",beforeSend:function(){e.find(".TournamentGames .update-games").attr("disabled",!0)},success:function(a){if(a.status){console.log(a.message);var t=null;if(a.data.refresh)return void window.location.reload();r.each(a.data.matchUpdates,function(a,d){e.data("id")==d.matchId&&d.finished&&e.find(".TournamentGames").removeClass("open"),n(d,t=r(".TournamentMatch[data-id='"+d.matchId+"']")),o(d,t.find(".TournamentGames"))}),UpdateStandings(d.tournamentId,d.bracketId)}else console.log("Error in updating");console.log(a)},error:function(e){console.log(e)},complete:function(){e.find(".TournamentGames .update-games").attr("disabled",!1)}})}),r(".TournamentGames .options .reset-match").on("click",function(){var e=r(this).closest(".TournamentMatch");r(this).closest(".bracket").data("id"),e.data("matchnum");r.ajax({url:"/Ajax/Bracket/MatchReset",type:"post",data:{tournamentId:r("#Tournament").data("id"),bracketId:r(this).closest(".bracket").data("id"),matchNum:e.data("matchnum")},dataType:"json",success:function(a){a.status&&(r.each(a.data,function(a,t){n(t,r(".TournamentMatch[data-id='"+t.matchId+"']")),t.matchNum==e.data("matchnum")&&o(t,e.find(".TournamentGames"))}),e.find(".TournamentGames .games").empty(),UpdateStandings(r("#Tournament").data("id"),e.closest(".bracket").data("id"))),console.log(a.message)},error:function(e){console.log(e)}})})});
jQuery(document).ready(function(){$(".clearButton").on("click",function(){$("#TournamentSearch .options .field").each(function(n,l){$(l).val("")}),$("#TournamentSearch .options .searchButton").click()}),$("#TournamentSearch .options .searchButton").on("click",function(){var n={};$("#TournamentSearch .options .field").each(function(l,t){n[$(t).attr("name")]=$(t).val()}),$.ajax({url:"/Ajax/Tournament/Search",type:"post",data:n,dataType:"json",success:function(n){var l=$("#TournamentSearch .list-table-body");l.empty(),$.each(n,function(n,t){html="<a class='column' href='"+t.link+"'> ",html+="<ul class='column-clickable' data-columns='5'> ",html+="<li class='column'>"+t.title+"</li> ",html+="<li class='column'>"+t.game+"</li> ",html+="<li class='column'>"+t.platform+"</li> ",html+="<li class='column'>"+t.startDate+"</li> ",html+="<li class='column'>"+(t.publicRegistration?"Public":"Private")+"</li> ",html+="</ul> ",html+="</a> ",l.append(html)}),console.log(n)},error:function(n){console.log(n)}})}),function(n){n("#TournamentSearch .options").each(function(l,t){n(t).find("input").val(""),n(t).find("select").val("")})}($)});
function UpdateStandings(e,n){if(e=parseInt(e,10),n=parseInt(n,10),isNaN(e)||isNaN(n))return!1;$.ajax({url:"/Ajax/Bracket/Standings",type:"POST",data:{tournamentId:e,bracketId:n},dataType:"json",success:function(e){if(e.status){var t=$(".TournamentInfo .bracketData[data-bracket='"+n+"'] .standingInfo");t.find(".data").remove(),$.each(e.data.ranks,function(n,a){html="<ul class='data' data-columns='3'> ",html+="<li class='column rank'>"+a.Rank+"</li> ",html+="<li class='column name'>"+a.Name+"</li> ",e.data.usePoints?html+="<li class='column score'>"+a.Wins+" - "+a.Losses+" - "+a.Ties+"</li> ":html+="<li class='column score'></li> ",html+="</ul> ",t.append(html)})}console.log(e.message)},error:function(e){console.log(e)}})}jQuery(document).ready(function(){function e(e){u("#Tournament .bracket[data-id='"+e+"']").addClass("selected").siblings().removeClass("selected")}function n(){var e=u(this).data("bracket");u(".TournamentInfo .bracketData, .TournamentInfo .bracketNum").removeClass("show"),u(this).addClass("show"),u(this).siblings(".TournamentInfo .bracketData[data-bracket='"+e+"']").addClass("show")}function t(){var e=u(this).closest(".bracketData"),n=u(this).data("show");u(this).addClass("show").siblings().removeClass("show"),e.find("."+n).addClass("show").siblings().removeClass("show")}function a(){var e=u(this);u.ajax({url:"/Ajax/Tournament/CheckIn",type:"post",data:{tournamentId:u("#Tournament").data("id"),tournamentUserId:u(this).closest(".data").data("user")},dataType:"json",beforeSend:function(){e.off("click")},success:function(n){n.status&&(e.removeClass("green"),e.removeClass("red"),e.addClass(n.isCheckedIn?"green":"red")),console.log(n.message)},error:function(e){console.log(e)},complete:function(){e.on("click",a)}})}function o(e,n){userElement=u(this).closest(".user"),jsonData={tournamentId:u("#Tournament").data("id"),targetUser:userElement.data("user"),action:n||u(this).attr("class")},-1==jsonData.targetUser?userElement.remove():u.ajax({url:"/Ajax/Tournament/PermissionChange",type:"POST",data:jsonData,dataType:"json",beforeSend:function(){userElement.find(".actions").find("button").attr("disabled",!0),userElement.find(".promote").off("click"),userElement.find(".demote").off("click")},success:function(e){e.status&&(0==e.data.permissions.Permission?userElement.remove():(userElement.find(".actions").html(s(e.data.permissions)),userElement.find(".permission").text(m[e.data.permissions.Permission]),userElement.find(".checkedIn").removeClass("red green").addClass(e.data.isCheckedIn?"green":"red"))),console.log(e)},error:function(e){alert(e.message)},complete:function(){userElement.find(".promote, .demote").on("click",o),userElement.find(".actions").find("button").attr("disabled",!1)}})}function s(e){return html="",demoteButton=" <button class='demote'>Demote</button> ",promoteButton=" <button class='promote'>Promote</button> ",removeButton=" <button class='remove'>Remove</button> ",e.Promote&&(html+=promoteButton),e.Demote&&(html+=demoteButton),e.Remove&&(html+=removeButton),html}function r(e){$this=u(e?e:this);var n=$this.closest(".userAddData");if(n.find(".name input").val().length<1)return!1;var t={tournamentId:u("#Tournament").data("id"),name:n.find(".name input").val(),bracketId:n.closest(".bracketData").data("id")};u.ajax({url:"/Ajax/Tournament/Register",type:"post",data:t,dataType:"json",beforeSend:function(){n.find(".addUserButton").attr("disabled",!0),n.find(".name input").attr("disabled",!0)},success:function(e){e.status&&(html="<ul class='data user form' data-user='"+e.data.user.TournamentUserId+"' data-columns='5'> ",html+="<li class='column name'>"+e.data.user.Name+"</li> ",html+="<li class='column permission'>"+m[e.data.user.Permission]+"</li> ",html+="<li class='column seed'><input type='text' name='seedVal' maxlength='2' value='"+e.data.user.Seed+"'/></li>",html+="<li class='column'><span class='icon icon-checkmark red'></span></li> ",html+="<li class='column actions'>"+s(e.data.actions)+"</li> ",html+="</ul> ",n.closest(".infoSection").find(".user:last").after(html),n.find(".name input").val(""),u(".TournamentInfo .user .actions .remove").off("click"),u(".TournamentInfo .user .actions .remove").on("click",o)),d=!0,console.log(e.message)},error:function(e){console.log(e)},complete:function(){n.find(".addUserButton").attr("disabled",!1),n.find(".name input").attr("disabled",!1),n.find(".name input").focus()}})}function i(){for(var e=u(this).closest(".playerInfo").find(".user input").toArray(),n=[];0!=e.length;){var t=Math.floor(Math.random()*e.length);n.push(e[t]),e.splice(t,1)}u.each(n,function(e,n){u(n).val(e+1)})}function c(){var e={tournamentId:u("#Tournament").data("id"),bracketId:u(this).closest(".bracketData").data("id"),players:{}};u(this).closest(".playerInfo").find(".user").each(function(n,t){1==u(t).find(".seed input").length&&(e.players[u(t).data("user")]=u(t).find(".seed input").val())}),u.ajax({url:"/Ajax/Tournament/SeedChange",type:"POST",data:e,dataType:"json",success:function(e){e.status&&(d=!0),console.log(e.message)},error:function(e){console.log("Error")}})}function l(){u.ajax({url:"/Ajax/Bracket/Reset",type:"POST",data:{tournamentId:u("#Tournament").data("id"),bracketId:u(this).closest(".bracketData").data("id")},dataType:"json",success:function(e){e.status?window.location.replace(e.redirect):alert(e.message)},error:function(e){console.log("Error")}})}var u=jQuery,d=!1,m={100:"Creator",101:"Admin",102:"Participant",0:"None"};u(".tournament-update").on("click",function(){window.location="/Tournament/Update/"+u(this).closest("#Tournament").data("id")}),u(".tournament-delete").on("click",function(){confirm("Are you sure you want to delete this tournament? This can no be reverted.")&&u.ajax({url:"/Ajax/Tournament/Delete",type:"POST",data:{tournamentId:u(this).closest("#Tournament").data("id")},dataType:"json",success:function(e){e.status?window.location.replace(e.redirect):alert(e.message)},error:function(e){alert(e.message)}})}),u(".tournamentFinalizeButton").on("click",function(){var e=u(this).closest(".bracket"),n={tournamentId:u("#Tournament").data("id"),bracketId:e.data("id"),roundData:{}};u.each(e.find(".header-rounds"),function(e,t){var a=1;u.each(u(t).find("li"),function(e,t){var o=u(t).data("type"),s=u(t).find(".bestOfMatches");s.length&&(n.roundData.hasOwnProperty(o)||(n.roundData[o]={}),n.roundData[o][a]=s.val(),a++)})}),u.ajax({url:"/Ajax/Tournament/Finalize",type:"POST",data:n,dataType:"json",success:function(e){location.replace(e.redirect),console.log(e)},error:function(e){console.log(e)}})}),u("#Tournament .tournament-buttons.options .checkIn").on("click",function(){u.ajax({url:"/Ajax/Tournament/CheckIn",type:"post",data:{tournamentId:u("#Tournament").data("id")},dataType:"json",success:function(e){e.status&&u("#Tournament .tournament-buttons.options .checkIn").remove(),console.log(e.message)},error:function(e){console.log(e)}})}),u("#Tournament .bracketNames .bracketName").on("click",function(){u(this).addClass("selected").siblings().removeClass("selected"),e(u(this).data("bracket"))}),u("#Tournament  .tournamentData").on("click",function(){u(".TournamentGames").removeClass("open");var e=u(".TournamentInfo");e.hasClass("open")?e.removeClass("open"):e.addClass("open")}),u(".TournamentInfo .close").on("click",function(){u(this).closest(".TournamentInfo").removeClass("open"),d&&location.reload()}),u(".TournamentInfo .bracketNum").on("click",n),u(".TournamentInfo .selection.info").on("click",t),u(".TournamentInfo .playerInfo .checkIn").on("click",a),u(".TournamentInfo .playerInfo .user .promote, .TournamentInfo .playerInfo .user .demote").on("click",o),u(".TournamentInfo .playerInfo .userAddData .addUserButton").on("click",function(){r(this)}),u(".TournamentInfo .playerInfo .userAddData .name").on("keydown",function(e){13==e.keyCode&&r(this)}),u(".TournamentInfo .resetInfo .reset-bracket").on("click",l),u(".TournamentInfo .playerInfo .adminSettings .randomSeeds").on("click",i),u(".TournamentInfo .playerInfo .adminSettings .updateSeeds").on("click",c),function(e){if(1==e(".TournamentInfo").length){var n=e(".TournamentInfo .playerInfo .user .permission");e.each(n,function(n,t){e(t).text(m[e(t).text()])}),1==e(".TournamentInfo .bracketNum").length&&e(".TournamentInfo .bracketNum")[0].click()}1==e("#Tournament").length&&1==e("#Tournament .bracketName").length&&e("#Tournament .bracketName")[0].click()}(u)});
jQuery(document).ready(function(){function e(){t("#TournamentEdit .bracketInfo").addClass("hide"),t("."+r[t("#TournamentEdit #BracketType").val()]).removeClass("hide")}var n,t=jQuery,r={3:"rr",6:"swiss"},a=0;t("#TournamentEdit #BracketType").on("change",e),t("#TournamentEdit .icon-plus").on("click",function(){var e=n.replace(/%n%/g,t("#TournamentEdit .brackets").length);t("#TournamentEdit .bracketSection").append("<ul class='brackets'>"+e+"</ul>"),a++}),function(t){1==t("#TournamentEdit").length&&(e(),n=t("#TournamentEdit .bracketOrig").removeClass("hide").html(),t("#TournamentEdit .bracketOrig").remove())}(t)});
jQuery(document).ready(function(){function c(){$brackets=e(this).closest(".list-table-body"),e.ajax({url:"/Ajax/Administrator/Bracket",type:"post",data:{bracketTypeId:e(this).closest(".bracket").data("id")},dataType:"json",beforeSend:function(){$brackets.find(".icon").off("click")},success:function(c){c.status&&e.each(c.brackets,function(c,o){$icon=e("#AdministratorBrackets .bracket[data-id='"+o.BracketTypeID+"'] .icon"),$icon.removeClass(),o.IsActive?$icon.addClass("green icon icon-checkmark"):$icon.addClass("red icon icon-cross")}),console.log(c.message)},error:function(c){console.log(c)},complete:function(){$brackets.find(".icon").on("click",c)}})}var e=jQuery;e("#AdministratorBrackets .bracket .icon").on("click",c)});
jQuery(document).ready(function(){function e(){a({function:"add",Title:i("#AdministratorGames .form .gameTitle .field").val()})}function t(){a({function:"delete",GameID:i(this).closest(".game").data("gameid")})}function a(e){i.ajax({url:"/Ajax/Administrator/Games",type:"POST",data:e,dataType:"json",beforeSend:function(){i("#AdministratorGames .gameDelete").off("click"),i("#AdministratorGames .GameAddButton").attr("disabled",!0)},success:function(e){if(e.status){var t=i("#AdministratorGames .list-table-body");t.empty(),i.each(e.data,function(e,a){html="<ul class='game' data-columns='2' data-gameid='"+a.GameTypeID+"'>",html+="<li class='column gameTitle'>"+a.Title+"</li>",html+="<li class='column gameDelete'><span class='icon icon-cross'></span></li>",html+="</ul>",t.append(html)}),i(".gameTitle input").val("")}console.log(e.message)},error:function(e){console.log("Failure"),console.log(e)},complete:function(){i("#AdministratorGames .gameDelete").on("click",t),i("#AdministratorGames .GameAddButton").attr("disabled",!1)}})}var i=jQuery;i("#AdministratorGames");i("#AdministratorGames .gameDelete").on("click",t),i("#AdministratorGames .GameAddButton").on("click",e),i("#AdministratorGames .options .gameTitle").on("keydown",function(t){t&&13==t.keyCode&&e()})});
jQuery(document).ready(function(){function t(){a({Platform:i.find(".options .platformTitle").val(),action:"add"})}function o(){a({PlatformId:l(this).closest("ul").data("id"),action:"delete"})}function a(t){l.ajax({url:"/Ajax/Administrator/Platform",type:"post",data:t,dataType:"json",beforeSend:function(){i.find(".options .AddPlatform").attr("disabled",!0),i.find(".options .platformTitle").attr("disabled",!0)},success:function(t){console.log(t);var a=l("#AdministratorPlatforms .list-table-body");a.empty(),l.each(t.platforms,function(t,o){html="<ul class='platform' data-columns='2' data-id='"+o.PlatformID+"'>",html+="<li class='column'>"+o.PlatformName+"</li>",html+="<li class='column'><span class='icon icon-cross removePlatform'></span></li>",html+="</ul>",a.append(html)}),i.find(".options .platformTitle").val(""),a.find(".removePlatform").off("click").on("click",o)},error:function(t){console.log(t)},complete:function(){i.find(".options .AddPlatform").attr("disabled",!1),i.find(".options .platformTitle").attr("disabled",!1)}})}var l=jQuery,i=l("#AdministratorPlatforms");l("#AdministratorPlatforms .platform .removePlatform").on("click",o),l("#AdministratorPlatforms .options .AddPlatform").on("click",t),l("#AdministratorPlatforms .options .platformTitle").on("keydown",function(o){o&&13==o.keyCode&&t()})});
