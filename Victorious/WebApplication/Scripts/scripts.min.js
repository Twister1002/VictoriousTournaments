...
jQuery(document).ready(function(a){a(".accountMenu .menu").on("click",function(){a(this).addClass("active").siblings().removeClass("active"),a("#Account"+a(this).data("type")).addClass("active").siblings().removeClass("active")})});
