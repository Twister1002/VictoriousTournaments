...
jQuery(document).ready(function(){function e(){t({function:"add",Title:i("#AdministratorGames .form .gameTitle .field").val()})}function a(){t({function:"delete",GameID:i(this).closest(".game").data("gameid")})}function t(e){i.ajax({url:"/Ajax/Administrator/Games",type:"POST",data:e,dataType:"json",beforeSend:function(){i("#AdministratorGames .gameDelete").off("click"),i("#AdministratorGames .GameAddButton").attr("disabled",!0)},success:function(e){if((e=JSON.parse(e)).status){var a=i("#AdministratorGames .list-table-body");a.empty(),i.each(e.data,function(e,t){html="<ul class='game' data-columns='2' data-gameid='"+t.GameTypeID+"'>",html+="<li class='column gameTitle'>"+t.Title+"</li>",html+="<li class='column gameDelete'><span class='icon icon-cross'></span></li>",html+="</ul>",a.append(html)}),i(".gameTitle input").val("")}console.log(e.message)},error:function(e){e=JSON.parse(e),console.log("Failure"),console.log(e)},complete:function(){i("#AdministratorGames .gameDelete").on("click",a),i("#AdministratorGames .GameAddButton").attr("disabled",!1)}})}var i=jQuery;i("#AdministratorGames");i("#AdministratorGames .gameDelete").on("click",a),i("#AdministratorGames .GameAddButton").on("click",e),i("#AdministratorGames .options .gameTitle").on("keydown",function(a){a&&13==a.keyCode&&e()})});
